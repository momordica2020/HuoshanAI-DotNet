...
namespace HuoshanAI.Threads
{
    ...
    /// </summary>
    public sealed class ThreadsEndpoint : HuoshanAIBaseEndpoint
    {
        public ThreadsEndpoint(HuoshanClient client) : base(client) { }
        ...
        {
            using var payload = request != null ? JsonSerializer.Serialize(request, HuoshanClient.JsonSerializationOptions).ToJsonStringContent() : null;
        ...
        {
            using var payload = JsonSerializer.Serialize(new { metadata }, HuoshanClient.JsonSerializationOptions).ToJsonStringContent();
        ...
        {
            using var payload = JsonSerializer.Serialize(message, HuoshanClient.JsonSerializationOptions).ToJsonStringContent();
