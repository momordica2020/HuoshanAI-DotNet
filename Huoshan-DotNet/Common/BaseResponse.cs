...
namespace HuoshanAI
{
    ...
    {
        /// <summary>
        /// The <see cref="HuoshanClient"/> this response was generated from.
        /// </summary>
        [JsonIgnore]
        public HuoshanClient Client { get; internal set; }
        ...
        /// This may be useful for troubleshooting or when contacting HuoshanAI support in reference to a specific request.
        /// </summary>
        [JsonIgnore]
        ...
        /// </summary>
        [JsonIgnore]
        public string HuoshanAIVersion { get; internal set; }
        ...
        */
        ...
        /// <summary>
        /// Takes a timestamp received from a HuoshanAI response header and converts to a TimeSpan
        /// </summary>
        /// <param name="timestamp">The timestamp received from an HuoshanAI header, e.g. x-ratelimit-reset-tokens</param>
