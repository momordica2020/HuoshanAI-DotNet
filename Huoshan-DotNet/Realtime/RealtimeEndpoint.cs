...
{
    public sealed class RealtimeEndpoint : HuoshanAIBaseEndpoint
    {
        internal RealtimeEndpoint(HuoshanClient client) : base(client) { }
        ...
        public async Task<RealtimeSession> CreateSessionAsync(SessionConfiguration configuration = null, CancellationToken cancellationToken = default)
        {
            ...
            {
                { "User-Agent", "HuoshanAI-DotNet" },
                { "HuoshanAI-Beta", "realtime=v1" },
