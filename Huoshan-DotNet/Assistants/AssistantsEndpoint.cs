...
namespace HuoshanAI.Assistants
{
    public sealed class AssistantsEndpoint : HuoshanAIBaseEndpoint
    {
        internal AssistantsEndpoint(HuoshanClient client) : base(client) { }
