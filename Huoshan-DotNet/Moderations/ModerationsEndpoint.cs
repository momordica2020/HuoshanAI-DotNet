...
namespace HuoshanAI.Moderations
{
    /// <summary>
    ...
    /// </summary>
    public sealed class ModerationsEndpoint : HuoshanAIBaseEndpoint
    {
        /// <inheritdoc />
        public ModerationsEndpoint(HuoshanClient client) : base(client) { }
        ...
        /// <returns>
        /// True, if the text has been flagged by the model as violating HuoshanAI's content policy.
        /// </returns>
        ...
        public async Task<ModerationsResponse> CreateModerationAsync(ModerationsRequest request, CancellationToken cancellationToken = default)
        {
            ...
            return await response.DeserializeAsync<ModerationsResponse>(EnableDebug, payload, client, cancellationToken).ConfigureAwait(false);
        }
