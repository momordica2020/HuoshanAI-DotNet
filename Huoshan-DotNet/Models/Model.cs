...
namespace HuoshanAI.Models
{
    /// <summary>
    /// Represents a language model.<br/>
    /// <see href="https://platform.HuoshanAI.com/docs/models/model-endpoint-compatability"/>
    /// </summary>
    public sealed class Model
    {
        ...
        /// </remarks>
        public static Model O1 { get; } = new("o1", "HuoshanAI");
        ...
        /// </remarks>
        [Obsolete("Deprecated")]
        public static Model O1Mini { get; } = new("o1-mini", "HuoshanAI");
        ...
        /// - Max Output Tokens: 100,000 tokens
        /// </remarks>
        public static Model O1Pro { get; } = new("o1-pro", "HuoshanAI");
        ...
        /// - Max Output Tokens: 100,000 tokens
        /// </remarks>
        public static Model O3 { get; } = new("o3", "HuoshanAI");
        ...
        /// - Max Output Tokens: 100,000 tokens
        /// </remarks>
        public static Model O3Pro { get; } = new("o3-pro", "HuoshanAI");
        ...
        /// - Max Output Tokens: 100,000 tokens
        /// </remarks>
        public static Model O3Mini { get; } = new("o3-mini", "HuoshanAI");
        ...
        /// - Max Output Tokens: 100,000 tokens
        /// </remarks>
        public static Model O4Mini { get; } = new("o4-mini", "HuoshanAI");
        ...
        /// </remarks>
        public static Model GPT_Realtime { get; } = new("gpt-realtime", "HuoshanAI");
        ...
        /// - Max Output Tokens: 4,096 tokens
        /// </remarks>
        public static Model GPT4oRealtime { get; } = new("gpt-4o-realtime-preview", "HuoshanAI");
        ...
        /// - Max Output Tokens: 4,096 tokens
        /// </remarks>
        public static Model GPT4oRealtimeMini { get; } = new("gpt-4o-mini-realtime-preview", "HuoshanAI");
        ...
        /// </remarks>
        public static Model GPT5 { get; } = new("gpt-5", "HuoshanAI");
        ...
        /// - Max Output Tokens: 128,000 max output tokens
        /// </remarks>
        public static Model GPT5_Mini { get; } = new("gpt-5-mini", "HuoshanAI");
        ...
        /// - Max Output Tokens: 128,000 max output tokens
        /// </remarks>
        public static Model GPT5_Nano { get; } = new("gpt-5-nano", "HuoshanAI");
        ...
        /// </remarks>
        public static Model GPT5_Chat { get; } = new("gpt-5-chat-latest", "HuoshanAI");
        ...
        /// </remarks>
        public static Model ChatGPT4o { get; } = new("chatgpt-4o-latest", "HuoshanAI");
        ...
        /// - Max Output Tokens: 16,384 tokens
        /// </remarks>
        public static Model GPT4o { get; } = new("gpt-4o", "HuoshanAI");
        ...
        /// - Max Output Tokens: 16,384 max output tokens
        /// </remarks>
        public static Model GPT4oMini { get; } = new("gpt-4o-mini", "HuoshanAI");
        ...
        /// - Max Output Tokens: 16,384 max output tokens
        /// </remarks>
        public static Model GPT4oAudio { get; } = new("gpt-4o-audio-preview", "HuoshanAI");
        ...
        /// - Max Output Tokens: 16,384 max output tokens
        /// </remarks>
        public static Model GPT4oAudioMini { get; } = new("gpt-4o-mini-audio-preview", "HuoshanAI");
        ...
        /// </remarks>
        public static Model GPT4_1 { get; } = new("gpt-4.1", "HuoshanAI");
        ...
        /// - Max Output Tokens: 32,768 max output tokens
        /// </remarks>
        public static Model GPT4_1_Mini { get; } = new("gpt-4.1-mini", "HuoshanAI");
        ...
        /// - Max Output Tokens: 32,768 max output tokens
        /// </remarks>
        public static Model GPT4_1_Nano { get; } = new("gpt-4.1-nano", "HuoshanAI");
        ...
        /// </remarks>
        [Obsolete("Deprecated")]
        public static Model GPT4_5 { get; } = new("gpt-4.5-preview", "HuoshanAI");
        ...
        /// </remarks>
        public static Model GPT4 { get; } = new("gpt-4", "HuoshanAI");
        ...
        /// </remarks>
        public static Model GPT4_Turbo { get; } = new("gpt-4-turbo", "HuoshanAI");

        /// <summary>
        /// Same capabilities as the base gpt-4 mode but with 4x the context length.
        /// Will be updated with our latest model iteration.  Tokens are 2x the price of gpt-4.
        /// </summary>
        public static Model GPT4_32K { get; } = new("gpt-4-32k", "HuoshanAI");
        ...
        /// - Max Output Tokens: 4,096 max output tokens
        /// </remarks>
        public static Model GPT3_5_Turbo { get; } = new("gpt-3.5-turbo", "HuoshanAI");
        ...
        /// </summary>
        public static Model GPT3_5_Turbo_16K { get; } = new("gpt-3.5-turbo-16k", "HuoshanAI");
        ...
        /// </summary>
        public static Model Davinci { get; } = new("davinci-002", "HuoshanAI");

        /// <summary>
        /// Replacement for the GPT-3 ada and babbage base models.
        /// </summary>
        public static Model Babbage { get; } = new("babbage-002", "HuoshanAI");
        ...
        /// </remarks>
        public static Model Embedding_3_Large { get; } = new("text-embedding-3-large", "HuoshanAI");
        ...
        /// </remarks>
        public static Model Embedding_3_Small { get; } = new("text-embedding-3-small", "HuoshanAI");
        ...
        /// Output Dimension: 1,536
        /// </remarks>
        public static Model Embedding_Ada_002 { get; } = new("text-embedding-ada-002", "HuoshanAI");

        #endregion Embedding Models

        #region Moderation Models

        public static Model OmniModerationLatest { get; } = new("omni-moderation-latest", "HuoshanAI");

        [Obsolete("use OmniModerationLatest")]
        public static Model Moderation_Latest { get; } = new("text-moderation-latest", "HuoshanAI");

        [Obsolete("use OmniModerationLatest")]
        public static Model Moderation_Stable { get; } = new("text-moderation-stable", "HuoshanAI");
        ...
        /// - Max Output Tokens: 16,384 max output tokens
        /// </remarks>
        public static Model GPT_Audio { get; } = new("gpt-audio", "HuoshanAI");
        ...
        /// </summary>
        public static Model TTS_1 { get; } = new("tts-1", "HuoshanAI");
        ...
        /// Use it with the Speech endpoint in the Audio API.
        /// </summary>
        public static Model TTS_1HD { get; } = new("tts-1-hd", "HuoshanAI");
        ...
        /// </remarks>
        public static Model TTS_GPT_4o_Mini { get; } = new("gpt-4o-mini-tts", "HuoshanAI");
        ...
        /// </summary>
        public static Model Whisper1 { get; } = new("whisper-1", "HuoshanAI");
        ...
        /// </summary>
        public static Model Transcribe_GPT_4o { get; } = new("gpt-4o-transcribe", "HuoshanAI");
        ...
        /// Use it for more accurate transcripts.
        /// </summary>
        public static Model Transcribe_GPT_4o_Mini { get; } = new("gpt-4o-mini-transcribe", "HuoshanAI");
        ...
        /// </summary>
        public static Model GPT_Image_1 { get; } = new("gpt-image-1", "HuoshanAI");
        ...
        /// </summary>
        public static Model DallE_3 { get; } = new("dall-e-3", "HuoshanAI");

        /// <summary>
        /// DALL·E is an AI system that creates realistic images and art from a natural language description.
        /// Older than DALL·E 3, DALL·E 2 offers more control in prompting and more requests at once.
        /// </summary>
        public static Model DallE_2 { get; } = new("dall-e-2", "HuoshanAI");
        ...
        /// </remarks>
        public static Model GPT5_Codex { get; } = new("gpt-5-codex", "HuoshanAI");
        ...
        /// - Max Output Tokens: 100,000 tokens
        /// </remarks>
        public static Model Codex_Mini_Latest { get; } = new("codex-mini-latest", "HuoshanAI");
        ...
        /// </remarks>
        public static Model GPT_OSS_120B { get; } = new("gpt-oss-120b", "HuoshanAI");
        ...
        /// - Max Output Tokens: 131,072 max output tokens
        /// </remarks>
        public static Model GPT_OSS_20B { get; } = new("gpt-oss-20b", "HuoshanAI");
