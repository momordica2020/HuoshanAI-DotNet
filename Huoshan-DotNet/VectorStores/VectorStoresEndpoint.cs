...
namespace HuoshanAI.VectorStores
{
    /// <summary>
    /// Vector stores are used to store files for use by the file_search tool.
    /// <see href="https://platform.HuoshanAI.com/docs/api-reference/vector-stores"/>
    /// </summary>
    public sealed class VectorStoresEndpoint : HuoshanAIBaseEndpoint
    {
        public VectorStoresEndpoint(HuoshanClient client) : base(client) { }
        ...
        {
            using var payload = JsonSerializer.Serialize(request, HuoshanClient.JsonSerializationOptions).ToJsonStringContent();
            using var response = await PostAsync(GetUrl(), payload, cancellationToken).ConfigureAwait(false);
            return await response.DeserializeAsync<VectorStoreResponse>(EnableDebug, payload, client, cancellationToken).ConfigureAwait(false);
        }
        ...
        public async Task<ListResponse<VectorStoreResponse>> ListVectorStoresAsync(ListQuery query = null, CancellationToken cancellationToken = default)
        {
            ...
            return await response.DeserializeAsync<ListResponse<VectorStoreResponse>>(EnableDebug, client, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            using var response = await GetAsync(GetUrl($"/{vectorStoreId}"), cancellationToken).ConfigureAwait(false);
            return await response.DeserializeAsync<VectorStoreResponse>(EnableDebug, client, cancellationToken).ConfigureAwait(false);
        }
        ...
        public async Task<VectorStoreResponse> ModifyVectorStoreAsync(string vectorStoreId, string name = null, int? expiresAfter = null, IReadOnlyDictionary<string, object> metadata = null, CancellationToken cancellationToken = default)
        {
            ...
            using var payload = JsonSerializer.Serialize(request, HuoshanClient.JsonSerializationOptions).ToJsonStringContent();
            using var response = await PostAsync(GetUrl($"/{vectorStoreId}"), payload, cancellationToken).ConfigureAwait(false);
            return await response.DeserializeAsync<VectorStoreResponse>(EnableDebug, payload, client, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            using var response = await DeleteAsync(GetUrl($"/{vectorStoreId}"), cancellationToken).ConfigureAwait(false);
        ...
        {
            using var payload = JsonSerializer.Serialize(new { file_id = fileId, chunking_strategy = chunkingStrategy }, HuoshanClient.JsonSerializationOptions).ToJsonStringContent();
            using var response = await PostAsync(GetUrl($"/{vectorStoreId}/files"), payload, cancellationToken).ConfigureAwait(false);
            return await response.DeserializeAsync<VectorStoreFileResponse>(EnableDebug, payload, client, cancellationToken).ConfigureAwait(false);
        }
        ...
        public async Task<ListResponse<VectorStoreFileResponse>> ListVectorStoreFilesAsync(string vectorStoreId, ListQuery query = null, VectorStoreFileStatus? filter = null, CancellationToken cancellationToken = default)
        {
            ...
            using var response = await GetAsync(GetUrl($"/{vectorStoreId}/files", queryParams), cancellationToken).ConfigureAwait(false);
            return await response.DeserializeAsync<ListResponse<VectorStoreFileResponse>>(EnableDebug, client, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            using var response = await GetAsync(GetUrl($"/{vectorStoreId}/files/{fileId}"), cancellationToken).ConfigureAwait(false);
            return await response.DeserializeAsync<VectorStoreFileResponse>(EnableDebug, client, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            using var response = await DeleteAsync(GetUrl($"/{vectorStoreId}/files/{fileId}"), cancellationToken).ConfigureAwait(false);
            var result = await response.DeserializeAsync<DeletedResponse>(EnableDebug, client, cancellationToken).ConfigureAwait(false);
            return result?.Deleted ?? false;
        }
        ...
        public async Task<VectorStoreFileBatchResponse> CreateVectorStoreFileBatchAsync(string vectorStoreId, IReadOnlyList<string> fileIds, ChunkingStrategy chunkingStrategy = null, CancellationToken cancellationToken = default)
        {
            ...
            using var payload = JsonSerializer.Serialize(new { file_ids = fileIds, chunking_strategy = chunkingStrategy }, HuoshanClient.JsonSerializationOptions).ToJsonStringContent();
            using var response = await PostAsync(GetUrl($"/{vectorStoreId}/file_batches"), payload, cancellationToken).ConfigureAwait(false);
            return await response.DeserializeAsync<VectorStoreFileBatchResponse>(EnableDebug, payload, client, cancellationToken).ConfigureAwait(false);
        }
        ...
        public Task<VectorStoreFileBatchResponse> CreateVectorStoreFileBatchAsync(string vectorStoreId, IReadOnlyList<FileResponse> files, ChunkingStrategy chunkingStrategy = null, CancellationToken cancellationToken = default)
            => CreateVectorStoreFileBatchAsync(vectorStoreId, files?.Select(file => file.Id).ToList(), chunkingStrategy, cancellationToken);
        ...
        public async Task<ListResponse<VectorStoreFileBatchResponse>> ListVectorStoreBatchFilesAsync(string vectorStoreId, string fileBatchId, ListQuery query = null, VectorStoreFileStatus? filter = null, CancellationToken cancellationToken = default)
        {
            ...
            using var response = await GetAsync(GetUrl($"/{vectorStoreId}/file_batches/{fileBatchId}/files", queryParams), cancellationToken).ConfigureAwait(false);
            return await response.DeserializeAsync<ListResponse<VectorStoreFileBatchResponse>>(EnableDebug, client, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            using var response = await GetAsync(GetUrl($"/{vectorStoreId}/file_batches/{fileBatchId}"), cancellationToken).ConfigureAwait(false);
            return await response.DeserializeAsync<VectorStoreFileBatchResponse>(EnableDebug, client, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            using var response = await PostAsync(GetUrl($"/{vectorStoreId}/file_batches/{fileBatchId}/cancel"), null!, cancellationToken).ConfigureAwait(false);
            var result = await response.DeserializeAsync<VectorStoreFileBatchResponse>(EnableDebug, client, cancellationToken).ConfigureAwait(false);
