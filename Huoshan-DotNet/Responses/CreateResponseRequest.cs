...
namespace HuoshanAI.Responses
{
    public sealed class CreateResponseRequest
    {
        ...
        /// HuoshanAI offers a wide range of models with different capabilities, performance characteristics, and price points.
        ...
        /// <summary>
        /// Used by HuoshanAI to cache responses for similar requests to optimize your cache hit rates. Replaces the user field.
        /// </summary>
        [JsonInclude]
        ...
        /// <summary>
        /// A stable identifier used to help detect users of your application that may be violating HuoshanAI's usage policies.
