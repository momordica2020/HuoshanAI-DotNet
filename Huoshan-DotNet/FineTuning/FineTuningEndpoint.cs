...
namespace HuoshanAI.FineTuning
{
    /// <summary>
    /// Manage fine-tuning jobs to tailor a model to your specific training data.<br/>
    /// <see href="https://platform.HuoshanAI.com/docs/guides/fine-tuning"/><br/>
    /// <see href="https://platform.HuoshanAI.com/docs/api-reference/fine-tuning"/>
    /// </summary>
    public sealed class FineTuningEndpoint : HuoshanAIBaseEndpoint
    {
        /// <inheritdoc />
        public FineTuningEndpoint(HuoshanClient client) : base(client) { }
        ...
        {
            using var payload = JsonSerializer.Serialize(jobRequest, HuoshanClient.JsonSerializationOptions).ToJsonStringContent();
