...
{
    /// <summary>
    /// https://github.com/HuoshanAI/HuoshanAI-cookbook/blob/main/examples/Assistants_API_overview_python.ipynb
    /// </summary>
    internal class TestFixture_03_Threads : AbstractTestFixture
    {
        ...
        {
            Assert.IsNotNull(HuoshanAIClient.ThreadsEndpoint);
            ThreadResponse thread = null;

            try
            {
                thread = await HuoshanAIClient.ThreadsEndpoint.CreateThreadAsync(new(
        ...
        public async Task Test_02_Thread_Messages()
        {
            ...
            try
            {
                ...
                try
                {
                    thread = await HuoshanAIClient.ThreadsEndpoint.CreateThreadAsync();
        ...
        {
            Assert.NotNull(HuoshanAIClient.ThreadsEndpoint);
            var assistant = await HuoshanAIClient.AssistantsEndpoint.CreateAssistantAsync(
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        public async Task Test_03_02_02_CreateRun_Streaming_ToolCalls()
        {
            ...
            var assistant = await HuoshanAIClient.AssistantsEndpoint.CreateAssistantAsync(assistantRequest);
            Assert.NotNull(assistant);
            ThreadResponse thread = null;
        ...
        {
            Assert.NotNull(HuoshanAIClient.ThreadsEndpoint);
            var assistant = await HuoshanAIClient.AssistantsEndpoint.CreateAssistantAsync<MathResponse>(
                new CreateAssistantRequest(
                    name: "Math Tutor",
        ...
        public async Task Test_06_01_CreateThreadAndRun_Reasoning()
        {
            ...
            Assert.IsNotNull(HuoshanAIClient.AssistantsEndpoint);
