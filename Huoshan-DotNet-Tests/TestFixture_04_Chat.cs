...
namespace HuoshanAI.Tests
{
    internal class TestFixture_04_Chat : AbstractTestFixture
    {
        ...
        {
            Assert.IsNotNull(HuoshanAIClient.ChatEndpoint);
            ...
            var response = await HuoshanAIClient.ChatEndpoint.GetCompletionAsync(chatRequest);
        ...
        public async Task Test_01_02_GetChatStreamingCompletion()
        {
            ...
            var response = await HuoshanAIClient.ChatEndpoint.StreamCompletionAsync(chatRequest, partialResponse =>
            {
        ...
        public async Task Test_01_03_01_GetChatCompletion_Modalities()
        {
            ...
            response = await HuoshanAIClient.ChatEndpoint.GetCompletionAsync(chatRequest);
            Assert.IsNotNull(response);
            Assert.IsNotNull(response.Choices);
            Assert.IsNotEmpty(response.Choices);
            Assert.AreEqual(1, response.Choices.Count);
        ...
        public async Task Test_01_03_01_GetChatCompletion_Modalities_Streaming()
        {
            ...
            Assert.AreEqual(AudioFormat.Pcm16, chatRequest.AudioConfig.Format);
            Assert.AreEqual(Modality.Text | Modality.Audio, chatRequest.Modalities);
            var response = await HuoshanAIClient.ChatEndpoint.StreamCompletionAsync(chatRequest, Assert.IsNotNull, true);
            Assert.IsNotNull(response);
            Assert.IsNotNull(response.Choices);
            Assert.IsNotEmpty(response.Choices);
            Assert.AreEqual(1, response.Choices.Count);
            ...
            Assert.AreEqual(Role.Assistant, messages[2].Role);
            Assert.IsNotNull(messages[2].AudioOutput);
            response = await HuoshanAIClient.ChatEndpoint.StreamCompletionAsync(chatRequest, Assert.IsNotNull, true);
            Assert.IsNotNull(response);
            Assert.IsNotNull(response.Choices);
            Assert.IsNotEmpty(response.Choices);
            Assert.AreEqual(1, response.Choices.Count);
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        public async Task Test_01_05_01_GetChatStreamingCompletionEnumerableAsync()
        {
            ...
            await foreach (var partialResponse in HuoshanAIClient.ChatEndpoint.StreamCompletionEnumerableAsync(chatRequest, true))
            {
                try
                {
                    Assert.IsNotNull(partialResponse);
        ...
        public async Task Test_02_02_GetChatToolCompletion_Streaming()
        {
            ...
            response = await HuoshanAIClient.ChatEndpoint.StreamCompletionAsync(chatRequest, partialResponse =>
            {
                Assert.IsNotNull(partialResponse);
        ...
        public async Task Test_02_05_GetChat_Enumerable_TestToolCalls_Streaming()
        {
            ...
            await foreach (var streamResponse in HuoshanAIClient.ChatEndpoint.StreamCompletionEnumerableAsync(request))
            {
        ...
        public async Task Test_05_01_GetChat_JsonSchema()
        {
            ...
            var (mathResponse, chatResponse) = await HuoshanAIClient.ChatEndpoint.GetCompletionAsync<MathResponse>(chatRequest);
        ...
        public async Task Test_05_02_GetChat_JsonSchema_Streaming()
        {
            ...
            var (mathResponse, chatResponse) = await HuoshanAIClient.ChatEndpoint.StreamCompletionAsync<MathResponse>(chatRequest, partialResponse =>
            {
                Assert.IsNotNull(partialResponse);
