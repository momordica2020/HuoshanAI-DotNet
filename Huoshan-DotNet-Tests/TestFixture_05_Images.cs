...
namespace HuoshanAI.Tests
{
    internal class TestFixture_05_Images : AbstractTestFixture
    {
        ...
        {
            Assert.IsNotNull(HuoshanAIClient.ImagesEndPoint);
            var request = new ImageGenerationRequest("A house riding a velociraptor");
            var imageResults = await HuoshanAIClient.ImagesEndPoint.GenerateImageAsync(request);
        ...
        public async Task Test_02_01_CreateImageEdit()
        {
            ...
            var imageResults = await HuoshanAIClient.ImagesEndPoint.CreateImageEditAsync(request);
        ...
        public async Task Test_03_01_CreateImageVariation()
        {
            ...
            var imageResults = await HuoshanAIClient.ImagesEndPoint.CreateImageVariationAsync(request);
