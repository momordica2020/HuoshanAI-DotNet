...
using HuoshanAI.Tests.StructuredOutput;
using HuoshanAI.Tests.Weather;
using System;
...
namespace HuoshanAI.Tests
{
    internal class TestFixture_14_Responses : AbstractTestFixture
    {
        ...
        public void Test_00_01_ResponseRequest_Serialization()
        {
            ...
            var jsonPayload = JsonSerializer.Serialize(request, new JsonSerializerOptions(HuoshanClient.JsonSerializationOptions)
            {
                WriteIndented = true
            });
        ...
        {
            Assert.NotNull(HuoshanAIClient.ResponsesEndpoint);
            var response = await HuoshanAIClient.ResponsesEndpoint.CreateModelResponseAsync("Tell me a three sentence bedtime story about a unicorn.");
        ...
        {
            Assert.NotNull(HuoshanAIClient.ResponsesEndpoint);
            var response = await HuoshanAIClient.ResponsesEndpoint.CreateModelResponseAsync("Tell me a three sentence bedtime story about a unicorn.", async (@event, sseEvent) =>
            {
        ...
        public async Task Test_02_01_FunctionToolCall()
        {
            ...
            var response = await HuoshanAIClient.ResponsesEndpoint.CreateModelResponseAsync(request);
            Assert.NotNull(response);
            Assert.IsNotEmpty(response.Id);
            Assert.AreEqual(ResponseStatus.Completed, response.Status);
            var responseItem = response.Output.LastOrDefault();
            ...
            response = await HuoshanAIClient.ResponsesEndpoint.CreateModelResponseAsync(request);
            Assert.NotNull(response);
            Assert.IsNotEmpty(response.Id);
            Assert.AreEqual(ResponseStatus.Completed, response.Status);
        ...
        public async Task Test_02_02_FunctionToolCall_Streaming()
        {
            ...
            var response = await HuoshanAIClient.ResponsesEndpoint.CreateModelResponseAsync(request, StreamCallback);
            Assert.NotNull(response);
            Assert.IsNotEmpty(response.Id);
            Assert.AreEqual(ResponseStatus.Completed, response.Status);
            var responseItem = response.Output.LastOrDefault();
            ...
            Console.WriteLine($"{usedTool.Name}: {usedTool.Arguments}");
            response.PrintUsage();
            response = await HuoshanAIClient.ResponsesEndpoint.CreateModelResponseAsync(new(conversation, Model.GPT4_1_Nano, tools: tools), StreamCallback);
            Assert.NotNull(response);
            Assert.IsNotEmpty(response.Id);
            Assert.AreEqual(ResponseStatus.Completed, response.Status);
            responseItem = response.Output.LastOrDefault();
        ...
        {
            Assert.IsNotNull(HuoshanAIClient.ResponsesEndpoint);
            ...
            var (mathResponse, response) = await HuoshanAIClient.ResponsesEndpoint.CreateModelResponseAsync<MathResponse>(request);
            Assert.NotNull(response);
            Assert.IsNotEmpty(response.Id);
            Assert.AreEqual(ResponseStatus.Completed, response.Status);
        ...
        public async Task Test_04_02_JsonSchema_Streaming()
        {
            ...
            var request = new CreateResponseRequest(messages, model: Model.GPT4_1_Nano);
            var (mathResponse, response) = await HuoshanAIClient.ResponsesEndpoint.CreateModelResponseAsync<MathResponse>(request, StreamCallback);
            Assert.NotNull(response);
            Assert.IsNotEmpty(response.Id);
            Assert.AreEqual(ResponseStatus.Completed, response.Status);
            Assert.NotNull(mathResponse);
        ...
        public async Task Test_06_01_ImageGenerationTool()
        {
            ...
            var request = new CreateResponseRequest(
                ...
                tools: tools,
                toolChoice: "auto");
            var response = await HuoshanAIClient.ResponsesEndpoint.CreateModelResponseAsync(request, serverSentEvent =>
            {
        ...
        public async Task Test_07_01_MCPTool()
        {
            try
            {
                ...
                var response = await HuoshanAIClient.ResponsesEndpoint.CreateModelResponseAsync(request, StreamEventHandler);
