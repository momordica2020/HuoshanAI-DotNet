...
namespace HuoshanAI.Proxy
{
    public static class EndpointRouteBuilder
    {
        ...
        /// <summary>
        /// Maps the <see cref="HuoshanAIClient"/> endpoints.
        /// </summary>
        /// <param name="endpoints"><see cref="IEndpointRouteBuilder"/>.</param>
        /// <param name="client"><see cref="HuoshanAIClient"/>.</param>
        /// <param name="authenticationFilter"><see cref="IAuthenticationFilter"/>.</param>
        /// <param name="routePrefix">Optional, custom route prefix. i.e. '/HuoshanAI'.</param>
        public static void MapHuoshanAIEndpoints(this IEndpointRouteBuilder endpoints, HuoshanClient client, IAuthenticationFilter authenticationFilter, string routePrefix = "")
        {
            ...
            async Task HandleRequest(HttpContext httpContext, string endpoint)
            {
                try
                {
                    ...
                    if (client.Settings.IsAzureHuoshanAI)
                    {
